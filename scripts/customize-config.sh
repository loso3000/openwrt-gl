...
sed -i "s/hostname='OpenWrt'/hostname='Siropboy'/g" package/base-files/files/bin/config_generate
...
# Modify WiFi SSID
sed -i 's/set wireless.default_radio\${devidx}.ssid=OpenWrt/set wireless.default_radio\${devidx}.ssid=Siropboy/g' package/kernel/mac80211/files/lib/wifi/mac80211.sh
